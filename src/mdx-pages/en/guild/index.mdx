...
Golden Tomato aka GT is guild's official magazine which publishes around four times a year. Every guild member can write to the publication. Therefore you should contact the main editor at <a href="mailto:gt@as.fi">gt@as.fi</a> if producing a magazine kindles your spirit. Golden Tomato celebrates this year it's 17th birthday.

The guild magazine has it's own website at <a href="http://gt.as.fi">http://gt.as.fi</a>.

## The Board
The board members e-mail addresses are in the form of position@as.fi. The entire board can be reached at  <a href="mailto:board@as.fi">board@as.fi</a>. You can find the board's contact information on <a target='_self' href='/en/guild/board'>the board page</a>.