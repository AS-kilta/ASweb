...
The guild defines harassment in [Code of Conduct (CoC)](../docs/code-of-conduct) (only in Finnish) sections 1 and 2, and these sections are explained more in the [Plan for Equality](plan-for-equality) (only in Finnish).
...
2. Notify the event organizer or a Confidential Counselor. You can send a message on Telegram, reach them in person or use the <a href="https://forms.gle/ZsDiCTF9WhabRn8UA" target="_blank">Anonymous Contact Form</a>.
...
Ayy’s harassment contact persons can be reached at <a href="mailto:hairinta@ayy.fi">hairinta@ayy.fi</a> and additional information can be found from <a href="https://www.ayy.fi/en/services-for-members/ayys-harassment-contact-persons" target="_blank">Ayy's webpage</a>.
