    ...
    <PageLayout pageContext={pageContext} title="Studies">
      <div className={style.table}>
        <div className={style.list}>
          <p></p>
          <p>
            The AS study committee represents the interests of the AS students in the various institutions of the
            college and university. It communicates on the behalf of the students with these institutions, as well as
            directly with the school staff. If you are interested in discussing any peculiarities relating to your
            studies or want to give feedback, you can contact the opintomestari (opintomestari@as.fi).
          </p>
          ...
          <div>
            ...
            independently scan and public exams from different courses onto the website. It is a highly useful website
            for studying for exams you may have coming up.
          </div>

          <h2>FAQs</h2>
          <h3>1. I'm unable to attend a compulsory exam/lecture for a course, what should I do?</h3>
          <p>
            Contact your course's teachers and assistants as soon as possible. Their details are generally written on
            the Sisu course page and MyCourses. You can get alternate arrangements for course grading, through retake
            exams or extra assignments. Furthermore, many exam-based courses have retakes you can register for through
            Sisu.
          </p>
          ...
          <h3>
            4. I am struggling with certain aspects of my studies or want to take a break from them. Where can I get
            help?
          </h3>
          <p>
            If you are having issues with your study plan structure or want guidance on how to move forward with your
            degree, contact your study counselors through <a href={'https://mystudies.aalto.fi/s/'}>MyStudies</a>. You
            may also ask for help in career planning and stress management through study psychologists. This relevant
            support can be found through Aalto's{' '}
            <a href={'https://www.aalto.fi/en/services/where-to-get-guidance-and-support'}>support services</a>
          </p>
        </div>
        ...
        <div className={style.sidePanel}>
          ...
          <div className={style.sideList}>
            ...
            <div className={style.sideList}>
              ...
              <li>
                <a href={'https://www.nyyti.fi/en/'}>Nyyti.fi (mental health organization for students)</a>
              </li>
              <li>
                <a href={'https://www.aalto.fi/en/services/where-to-get-guidance-and-support'}>
                  Aalto's official guide on getting guidance and support
                </a>
              </li>
              <li>
                <a href={'https://mystudies.aalto.fi/s/'}>MyStudies (Aalto study guidance counsellors)</a>
              </li>
            </div>
          </div>
