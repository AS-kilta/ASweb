...
const Advocacy: React.FC<Props> = ({ pageContext }) => {
  return (
    <PageLayout pageContext={pageContext} title="Advocacy">
      <p>
        At Aalto, we believe in the power of advocacy to drive positive change and create a more inclusive and welcoming
        environment for all. Therefore, it is essential for everyone to be aware of their rights and surroundings,
        ensuring that their voices are not only heard but also respected and acted upon.
      </p>
      <h2>Halloped</h2>
      <p>
        Hallopeds are students chosen by the student union (AYY) to represent all students in university decisions. They
        bring in new ideas and ensure students' voices are heard in meetings with the representative board. Any Aalto
        student can apply to be a Halloped through an open application process.
      </p>
      <p>
        Applications are accepted through the halloped.fi portal every autumn. If you're uncertain about the positions,
        feel free to ask. Inform the Master of Studies or any board member, so that we can collaborate closely within
        the guild.
      </p>
      <p>
      ...
      <p>
        ...
        dean. It works to improve research and teaching quality by deciding on the curriculum, degree requirements, and
        student selection criteria. Additionally, it helps organize university events and awards honorary doctorates.
      </p>
