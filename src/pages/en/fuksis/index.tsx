    ...
    <PageLayout pageContext={pageContext} title="For Fuksis" background={heropic} heroHeight="tall">
      ...
      <div className={style.cardlist}>
        ...
        <circle className={ccStyle.badge}>
          ...
          &nbsp;or&nbsp;
          <a href="https://hoas.fi/en" target="_blank">
            HOAS
          </a>
        </circle>
      ...
      <div className={style.table}>
        <div className={style.list}>
          ...
          <ul>
            ...
            <li>
              <a href="https://aalto.fi/en" target="_blank">
                Aalto University
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="https://www.aalto.fi/en/services/aalto-space-mobile-application" target="_blank">
        ...
        <div className={style.list}>
          ...
          <ul>
            ...
            <li>
              <a href="https://www.hsl.fi/en/tickets-and-fares/hsl-card" target="_blank">
                Travel card
              </a>
            </li>
            <li>
              <a href="https://www.hsl.fi/en/tickets-and-fares/hsl-app" target="_blank">
                HSL application
              </a>
            </li>
          </ul>
...
export const Head: HeadFC<HeadProps> = () => <Meta lang="en" title="For Fuksis" />;

export const query = graphql`
  query ImgQuery {
    allFile(
      filter: { relativePath: { in: ["officials/2023/leevi_hormaluoma.jpg", "officials/2023/tuomas_nykanen.jpg"] } }
    ) {
      nodes {
        childImageSharp {
