    ...
    >
      <div className={`even-columns ${style.frontpagebox}`}>
        <div style={{ textAlign: "center" }}>
          <h2>What is AS?</h2>
          <p>
            AS is a student organisation that brings together Aalto University
            students from many different fields. Our guild includes students
            from Automation and Robotics, Information Technology, Digital
            Systems and Design and other related programmes. The guild organises
            leisure activities for its members, looks after their interests in
            matters related to their studies and maintains relations with
