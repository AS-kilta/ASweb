...
const Advocacy: React.FC<Props> = ({ pageContext }) => {
  return (
    <PageLayout pageContext={pageContext} title="Edunvalvonta">
      <p></p>
      <p>
        Automaatio- ja systeemitekniikan killlan opiskelijoiden koskevia päätöksiä tehdään Sähkötekniikan korkeakoulussa
        useassa eri toimielimessä. Näitä ovat muun muassa Sähkötekniikan akateeminen komitea, Sähkötekniikan
        kanditaattikoulutusneuvosto, Sähkötekniikan korkeakoulun opetuksen laatutoimikunta (paremmin tunnetusti OpLaa).
        Usein killan puheenjohtaja ja opintomestari edustavat kiltalaisia näissä toimielimissä.
      </p>
      <p>
      ...
      <p>
        ...
        tutkintovaatimuksista ja valintaperusteista. Koulutusneuvosto päättää koulutusohjelmien kehityksestä, opetuksen
        laadunvarmistuksesta sekä palautteen käsittelystä. Näiden lisäksi koulutusneuvosto nimeää kandidaatintöiden
        hyväksyjät, päättää diplomitöiden aiheet, valvojat ja ohjaajat sekä arvostelee diplomityöt.
      </p>
      ...
      <p>
        ...
        opetusta huomioiden Aalto-yliopiston ja ELEC:n tavoitteiden lisäksi muut opetusta ja oppimista kehittävät teemat
        ja kehittämiskohteet. OpLaan jäsenillä on mahdollisuus osallistua henkilökunnan rekrytointiin. Lisäksi OpLaan
        jäsenille esitellään vuosittain tehdyn opintokyselyn tulokset.
      </p>
