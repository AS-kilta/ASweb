...
const Partners: React.FC<PageProps> = ({ pageContext }) => {
  ...
  return (
    <PageLayout pageContext={pageContext} background="https://as.fi/static/abimarkkinointi/Antti_Regelin.jpg" heroHeight="60" title="Yrityksille">
      ...
      <div className={style.title_container}><h3 className={style.top_title}>Yhteistyö killan kanssa</h3></div>
        <div>
      ...
      <section className={style.products}>
        <div className={style.title_container}><h3>Excursiot</h3></div>
        ...
        <div className={style.title_container}><h3>Haalarit</h3></div>
        <div className={style.columns}>
          <div className={style.intro}>
            <p className={style.text_box}>
        ...
        <div className={style.title_container}><h3>Rekrytointinäkyvyys</h3></div>
        <div className={style.columns}>
          <div className={style.intro}>
            <p className={style.text_box}>
        ...
        <div className={style.title_container}><h3>…ja myös paljon muuta!</h3></div>
        <div className={style.columns}>
          <div className={style.intro}>
            <p className={style.text_box}>
