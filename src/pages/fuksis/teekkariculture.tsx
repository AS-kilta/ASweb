...
const Teekkariculture: React.FC<PageProps> = ({ pageContext }) => {
  return (
    <PageLayout pageContext={pageContext} title='Teekkarikulttuuri' background='https://as.fi/static/abimarkkinointi/Antti_Regelin.jpg' heroHeight='tall'>
        ...
        <h2 id='haalarit' className={style.heading2}>Haalarit</h2>
        ...
        <h3 id='tilaaminen' className={style.heading3}> Tilaaminen </h3>
        ...
        <h2 id='teekkarilakki' className={style.heading2}> Teekkarilakki </h2>
        ...
        <h3 id='lakin-kaytto' className={style.heading3}> Lakin käyttö </h3>

        <div className={style.text}>
          <p>Teekkarilakki on teekkareiden tunnusmerkki, jonka saa painaa päähänsä ensimmäisenä Wappunaan. Nykyisen mallinen lakki on keikkunut teekkareiden päässä jo yli sadan vuoden ajan. Päällisin puolin se muistuttaa tavallista ylioppilaslakkia, mutta sen kuusi kulmaa, musta tuuhea tupsu ja hammasrataskokardi viestivät kaukaa kantajansa arvokkuudesta.</p>
        </div>

        <h3 id='oikeus-lakin-kayttoon' className={style.heading3}> Oikeus lakin käyttöön </h3>
