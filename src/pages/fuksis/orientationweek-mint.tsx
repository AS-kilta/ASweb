  ...
  return (
    ...
    >
      ...
      <div className="image-container">
        ...
        <p>
          Tässä ovat maisteriopiskelijoiden ja kansainvälisten opiskelijoiden orientaatioviikon aikataulut.
          Löytääksesi perille aikatauluissa mainittuihin paikkoihin suosittelemme lataamaan {" "}
          <a
...
export const Head: HeadFC<HeadProps> = () => <Meta lang="fi" title="MINT Orientaatioviikko" description={description} />;
