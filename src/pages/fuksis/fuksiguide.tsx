...
const Fuksiguide: React.FC<PageProps> = ({ pageContext }) => {
  return (
    <PageLayout pageContext={pageContext} title="Fuksiopas 2023">
      ...
      <div>
        <iframe src="https://drive.google.com/file/d/14Ew0gsN5HKbIRWwXVne50ICVLe5d35TC/preview" width="640" height="480" allow="autoplay"></iframe>
      </div>
    </PageLayout>
  )
}
